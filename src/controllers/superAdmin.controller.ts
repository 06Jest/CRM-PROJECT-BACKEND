...
export const getActiveAdmins = async (
  ...
  try{
    ...
    const result = await getActiveSubscribersFromDB();
    res.status(200).json({
      success: true,
      data: result,
    });
...
export const getAllSubscribers = async (
  ...
  try{
    ...
    const result = await getAllSubscribersFromDB();
    res.status(200).json({
      success: true,
      data: result,
    });
...
export const updateAdminStatus = async (
  ...
  try{
    const { id, org_id,  status}  = req.body;
    const role = req.user?.role;
    ...
    const result = await updateProfileStatusFromDB(id, org_id, status);
    res.status(200).json({
      success: true,
      data: result,
    });
